...
class WPC_MP_Settings {
	...
	public function mp_add_admin_menu() {
		...
		add_submenu_page( 'wpcargo-settings', __( 'Multiple Package Settings', 'wpcargo-multiple-package' ), __( 'Multiple Package Settings', 'wpcargo-multiple-package' ), 'manage_options', 'admin.php?page=wpc-multiple-package');		
	...
	public function wpc_mp_settings_init(  ) { 
		...
		add_settings_field( 
			...
			__( 'Enable Multilple Package on Admin?', 'wpcargo-multiple-package' ), 
		...
		add_settings_field( 
			...
			__( 'Enable Multilple Package on Results?', 'wpcargo-multiple-package' ), 
		...
		add_settings_field( 
			...
			__( 'Enable Dimension Unit?', 'wpcargo-multiple-package' ), 
		...
		add_settings_field( 
			...
			__( 'Dimension Unit', 'wpcargo-multiple-package' ), 
		...
		add_settings_field( 
			...
			__( 'Weight Unit', 'wpcargo-multiple-package' ), 
		...
		add_settings_field( 
			...
			__( 'Piece Type Selection', 'wpcargo-multiple-package' ), 
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>If checked you will enable the multiple package on your shipment admin dashboard.</i></p>
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>If checked you will enable the multiple package on your shipment results.</i></p>
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>If checked you will enable the dimension unit.</i></p>
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>This will be display in the package Dimension. Example: mm, cm, inch, etc. The default is cm.</i></p>
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>This will be display in the package Weight. Example: lbs, g, gr, kg, etc. The default is lbs.</i></p>
	...
	$options = get_option( 'wpc_mp_settings' );
		...
		?>
			...
			<p><i>This will be the selection for the Piece Type for the Package Information section. Comma separated ( Ex. Pallet, Carton, Crate, Loose, Others)</i></p>
	...
	public function wpc_mp_settings_section_callback(  ) { 	
		...
		echo __( 'Settings for Multiple Package, Please fill out the fields below.', 'wpcargo-multiple-package' );	
	...
	public function wpc_mp_add_settings_nav() {
		...
		?>	
			...
			<a class="nav-tab <?php echo ( $view == 'wpc-multiple-package') ? 'nav-tab-active' : '' ;  ?>" href="<?php echo admin_url().'admin.php?page=wpc-multiple-package'; ?>" ><?php _e('Multiple Package Settings', 'wpcargo-multiple-package'); ?></a>
