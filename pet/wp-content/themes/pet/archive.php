        	...
        	<div class="container clearfix">        
          		<div class="inner-main-container">
              		<div class="blogg clearfix">
						...
						<?php if ( is_day() ) : ?>
							<?php printf( __( 'Daily Archives: %s', 'pet' ), get_the_date() ); ?>
						<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly Archives: %s', 'pet' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'pet' ) ) ); ?>
						<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly Archives: %s', 'pet' ), get_the_date( _x( 'Y', 'yearly archives date format', 'pet' ) ) ); ?>
						<?php else : ?>
							<?php _e( 'Blog Archives', 'pet' ); ?>
						<?php endif; ?>
					</span></h2>
