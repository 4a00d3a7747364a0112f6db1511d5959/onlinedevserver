<?php
	...
	add_image_size( 'sb-custom-size-4', 176, 91 );
	...
	function sb_pet_widgets() {
		...
		register_sidebar( array(
			'name' => __( 'Posts by Category Sidebar', 'pet' ),
			'id' => 'posts-by-category-sidebar',
			'description' => __( 'This widget displayed in right sidebar of blog pages', 'pet' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3 class="widget-title">',
	...
	function sb_pet_ads_posttype() {
		register_post_type( 'pet_ads',
			// CPT Options
			array(
				'labels' => array(
				...
				'public' => true,
				'has_archive' => true,
				'rewrite' => array('slug' => 'pet_ads'),
				'supports' => array( 'title', 'thumbnail', ),
			)
		);
	}
	add_action( 'init', 'sb_pet_ads_posttype' );
