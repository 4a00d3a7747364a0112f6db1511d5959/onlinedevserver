...
<?php endif; ?>
		...
		<h2 style="display: none;"><?php _e( 'Login', 'woocommerce' ); ?></h2>
	       ...
	       <div class="form_area">
	           <div class="form_inner">
				...
				<form method="post" class="login1">
					...
					<div class="row clearfix forgot_area">
                          <div class="remember">
					...
					<div class="form-row signin_btn">
						<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
						<input type="submit" class="woocommerce-Button1 button1" name="login" value="<?php esc_attr_e( 'SIGN IN', 'woocommerce' ); ?>" />
					</div>
			...
			<div class="row join">
	            <a href="<?php echo esc_url( home_url() ); ?>/registration">Join Dewor Baby</a>
	      </div>
	  </div>
	</div>
	</div>
