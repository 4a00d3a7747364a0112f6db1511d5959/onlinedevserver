  ...
  <div class="sectionHeading">
    ...
    <div class="pro_circls">
      <div class="popbox crl1">
        ...
        <?php the_field('elastic_waist_band_section'); ?>
        </div>         
      </div>
      <div class="popbox crl2">
        <div class="circle">
         ...
         <div class="content"> 
         <div class="closeContent"><i class="fa fa-times"></i></div>         
          <?php the_field('fitting_leak_guard_section'); ?>
        </div>         
      </div>
      <div class="popbox crl3">
        <div class="circle">
         ...
         <div class="content"> 
         <div class="closeContent"><i class="fa fa-times"></i></div>
         <?php the_field('ultra_thin_absorbant_section'); ?>         
      ...
      <div class="popbox crl4">
        <div class="circle">
         ...
         <div class="content">          
         <div class="closeContent"><i class="fa fa-times"></i></div>
          <?php the_field('bamboo_top_sheet_section'); ?>
        </div>         
      </div>
      <div class="popbox crl5">
        <div class="circle">
         ...
         <div class="content">          
         <div class="closeContent"><i class="fa fa-times"></i></div>
          <?php the_field('magic_side_panel_section'); ?>
        </div>         
      </div>
      <div class="popbox crl6">
        <div class="circle">
         ...
         <div class="content">          
         <div class="closeContent"><i class="fa fa-times"></i></div>
          <?php the_field('bamboo_back_sheet_section'); ?>
        </div>         
      </div>
    </div>
    <?php
