            ...
            <div class="overlay">
              ...
              <div class="caption">
                <div class="capContent">
                    <div class="maincaptionHolder demo">
                      <div class="mainCapInner ">
                        <?php //echo $deworbaby_options['banner_content']; ?>
                        <h1>lUXURIOUS ECOFRIENDLY dIAPERS</h1>
                        <h4>on Your Budget</h4>
                      </div>
                    </div>
                </div>
...
<!-- about -->
  <section class="about clearfix">
    <div class="container clearfix">
      ...
      <a href="<?php echo site_url('/'); ?>our-story" class="btn show_now hvr-shutter-out-horizontal"><span class="hvr-shutter-out-horizontal">Learn More</span></a>
      </div>
