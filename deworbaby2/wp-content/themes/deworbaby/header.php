	           	...
	           	<nav class="right_part clearfix">
	               	<div class="close"><i class="fa fa-times"></i></div>
				        ...
				        ?>
	                  	 ...
	                  	 <li id="navds" class="hvr-underline-from-center">
							<?php if ( is_user_logged_in() ) { ?>
		                        <a class="signed-in" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php $current_user = wp_get_current_user(); echo $current_user->user_firstname; ?> </a>
		                        <ul class="sub-menu">
		                     ...
		                     <?php } 
		                        ...
		                        <a class="no-signin" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php _e('SIGN IN','deworbaby'); ?></a>
		                     <?php } ?>
	                  	</li> 
