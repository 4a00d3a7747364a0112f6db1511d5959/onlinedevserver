        ...
        if (typeof options == 'string') {
            ...
            selector.each(function(){
                ...
                if (options == 'getTags')
                    ...
                    $('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag" style="text-transform:uppercase;"></div><div class="tag-editor-delete"><i></i></div></li>').appendTo(ed).find('.tag-editor-tag')
        ...
        return selector.each(function(){
            ...
            for (var i=0; i<tags.length; i++) {
                ...
                if (tag) {
                    ...
                    ed.append('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag" style="text-transform: uppercase;">'+escape(tag)+'</div><div class="tag-editor-delete"><i></i></div></li>');
