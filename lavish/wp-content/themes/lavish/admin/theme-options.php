...
/*Mate Of The Year ANd Mate of The Month*/
$options[] = array( "name" => "General Settings For Mate Pages",
                    "type" => "heading");
					
$options[] = array( "name" => "Extra Content Mate Of The Year",
					"desc" => "Here you can enter any text",
					"id" => "webq_mate_extra",
					"std" => "",
					"type" => "webq_editor"); 

$options[] = array( "name" => "Extra Content Mate Of The Month",
					"desc" => "Here you can enter any text",
					"id" => "webq_mate_month",
					"std" => "",
					"type" => "webq_editor"); 
