  ...
  <div class="container">
       <div class="city-details about-bottom-content clearfix">
        <div class="city-details-left">
         <h3> Your gentleman feedback is important to our escort ladies  </h3>
         <p><?php echo get_post_meta($pid,'Your gentleman feedback is important to our escort ladies',true);?> </p>
        </div>
        <div class="city-details-right">
          <h3> 10 tips to make your escort date truly perfect </h3>
          <p> <?php echo get_post_meta($pid,'10 tips to make your escort date truly perfect',true);?> </p>
        </div>
       </div>
  </div>
</section>
