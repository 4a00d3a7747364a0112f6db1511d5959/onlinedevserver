...
<a href="#" class="add-request-quote-button button" data-product_id="96" data-wp_nonce="8267a7b841">
    Add to quote</a>
<img src="http://onlinedevserver.biz/dev/kisklenall/wp-content/plugins/yith-woocommerce-request-a-quote/assets/images/wpspin_light.gif" class="ajax-loading" alt="loading" width="16" height="16" style="visibility:hidden">    </div>
    </div>
                            </div>
                        </div>
                    </div>
