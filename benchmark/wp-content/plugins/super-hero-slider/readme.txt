...
Tags: slider, slideshow, slides, transition, transitions, animation, animations, layer slider, carousel, image slider, responsive, responsive slider, responsive slides, wordpress slider, wordpress slideshow, carousel slider, content slider, content slideshow, css3 slider, fullscreen slider, fullwidth slider, horizontal slider, HTML5 slider, image slider, image slideshow, responsive image slider, revolution slider, slider plugin, slider shortcode, slideshow plugin, swipe, swipe slider, touch slider, posts slider, recent posts slider, post slider, latest post slider, latest posts slider, posts slideshow, recent posts slideshow, product slider, products slider, product carousel, products carousel, woocommerce slider, woocommerce carousel, ecommerce slider, ecommerce carousel, full screen slider
...
* Fully extensible - filters throughout for developers to hook into
...
[Demos](http://superheroslider.catapultthemes.com/).
...
* Full screen sliders
* Carousels
* Recent posts sliders and carousels
