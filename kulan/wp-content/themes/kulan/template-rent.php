<?php
/**
 * Template Name: Rent Page Template
 * This template displays rent category listings
 */
...
get_header(); ?>
    ...
    <section id="inner-page">
        ...
        <div class="top-video-block">
            ...
            ?>
             <video width="100%" height="450" poster="<?php the_field('about_first_video_poster'); ?>" controls loop>
        ...
        <div class="kulan-dedication-block">
            <div class="container">
                ...
                ?>
                 <video width="100%" height="450" poster="<?php the_field('about_second_video_poster'); ?>" controls loop>
            ...
            <div class="main-history-block">
                ...
                <div class="about-kulan-slider">
                    ...
                    <?php
                      ...
                      if( $i%2 != 0 ){
                        echo '<div class="left-history">';
                      }else{
                        echo '<div class="right-history">';
                        } ?>
                            <div class="">
