...
*/
class Webshopapps_Premiumzone_Model_Mysql4_Carrier_Premiumzone_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct()
    {
        ...
        $this->_shipTable = Mage::getSingleton('core/resource')->getTableName('premiumzone_shipping/premiumzonematrix');
   	...
   	public function setPostcodeFilter($postcode)
    {
    	...
    	$zipCodeRangeFiltering = Mage::getStoreConfig('carriers/premiumzone/zip_range');
