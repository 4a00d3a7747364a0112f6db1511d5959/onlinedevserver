...
<p><?php printf( esc_html__( 'Hi there,', 'woocommerce-subscriptions-gifting' ) ); echo $dsname;?></p>
<p><?php printf( esc_html__( '%1$s just purchased %2$s for you at %3$s.', 'woocommerce-subscriptions-gifting' ), wp_kses( $subscription_purchaser, wp_kses_allowed_html( 'user_description' ) ), esc_html( _n( 'a gift', 'subscriptions', count( $subscriptions ), 'woocommerce-subscriptions-gifting' ) ), esc_html( $blogname ) ); ?>
<?php printf( esc_html__( ' Details of the %s are shown below.', 'woocommerce-subscriptions-gifting' ), esc_html( _n( 'gift', 'subscriptions', count( $subscriptions ), 'woocommerce-subscriptions-gifting' ) ) ); ?>
</p>

<p><?php printf( esc_html__( 'Your Gift Code : %s', 'woocommerce-subscriptions-gifting' ), '<strong>' . esc_html( $codeno ) . '</strong>' ); ?></p>
<p><?php
echo 'Gift Message: <br> '.$recipnote;?></p>
<?php
...
<p><?php printf( esc_html__( 'You may access your account area to view your new %1$s here: %2$sMy Account%3$s.', 'woocommerce-subscriptions-gifting' ),
	esc_html( _n( 'gift', 'subscriptions', count( $subscriptions ), 'woocommerce-subscriptions-gifting' ) ),
...
WC()->session->__unset('recipient_dsname');
WC()->session->__unset('recipnote');	
