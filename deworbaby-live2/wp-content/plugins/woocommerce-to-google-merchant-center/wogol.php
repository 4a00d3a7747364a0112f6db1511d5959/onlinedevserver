...
class WP_WooGool {
    ...
    private function define_constants() {
        ...
        $this->define( 'WOOGOOL_FEED_PER_PAGE', 100 );
    ...
    function scripts() {
        ...
        wp_enqueue_media();
        wp_enqueue_script( 'woogool-tipTip', plugins_url( '/assets/js/jquery.tipTip.min.js', __FILE__ ), array( 'jquery' ), time(), true );
        ...
        wp_enqueue_style( 'woogool-tipTip-style', plugins_url( 'assets/css/tipTip.min.css', __FILE__ ) );
