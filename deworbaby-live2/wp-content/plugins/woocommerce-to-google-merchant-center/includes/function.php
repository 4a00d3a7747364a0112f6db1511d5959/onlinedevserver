...
function woogool_warning() {
    ...
    <div>
        <label for=""><?php _e( 'Warning', 'woogool' ); ?></label>
        <h4>
            <span class="woogool-field">
                <?php _e( 'This feature is available for pro version.', 'woogool' ); ?> 
                <a href="http://mishubd.com/product/woogoo" target="_blank"><?php _e( 'Upgrade to Pro Version', 'woogool' ); ?></a>
            </span>
        </h4>
    </div>
