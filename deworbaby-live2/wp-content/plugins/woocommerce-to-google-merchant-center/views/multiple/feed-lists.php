<a href="http://mishubd.com/product/woogoo" class="button button-primary" target="_blank"><?php _e( 'Upgrade to Pro Version', 'woogool' ); ?></a>
	...
	<?php
		foreach ( $feeds as $key => $feed_obj ) {
			...
			<tr>
				...
				<td><a href="http://mishubd.com/product/woogoo" target="_blank"><?php _e('Update to pro version', 'woogool'); ?></a></td>
