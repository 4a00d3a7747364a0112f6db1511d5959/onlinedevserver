...
$feed_fields['html4'] = array(
	'type'       => 'html',
	'html'       => woogool_warning(),
);
...
<div class="postbox">
		...
		<div class="woogool-feed-form-content">
			...
			<?php
				...
				<a class="button button-primary" href="http://mishubd.com/product/woogoo/" target="_blank"><?php _e( 'Upgrade to Pro Version', 'woogool' ); ?></a>
