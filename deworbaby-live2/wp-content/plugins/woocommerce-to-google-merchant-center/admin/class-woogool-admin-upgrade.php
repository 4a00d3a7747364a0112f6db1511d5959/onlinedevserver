...
class WooGool_Admin_Upgrade {
    ...
    public function show_update_notice() {
        ...
        <div id="message" class="updated">
            ...
            <p class="submit"><a href="<?php echo add_query_arg( [ 'wp_woogool_do_update' => true ], $_SERVER['REQUEST_URI'] ); ?>" class="wp-update-btn button-primary"><?php _e( 'Run the updater', 'woogool' ); ?></a></p>
        </div>
    ...
    public function perform_updates() {
        ...
        $location = remove_query_arg( ['wp_woogool_do_update'], $_SERVER['REQUEST_URI'] );
