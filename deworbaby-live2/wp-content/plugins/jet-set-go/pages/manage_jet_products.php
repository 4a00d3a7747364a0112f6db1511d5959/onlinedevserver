			...
			<table class="wp-list-table widefat fixed striped posts" id="tbl_sort_product">
				<thead>
					<tr>
						...
						<th style="width:6%" class="manage-column column-qty sortable desc" id="product_status" scope="col">
							<a href="">
	...
	while ( $loop->have_posts() ) {
		...
		<tr class="iedit author-self jet-product-listing level-0 post-<?php echo $product_id;?> type-product status-publish hentry product_row" id="<?php echo $product_id;?>">
			...
			<td class="name column-visibility" id="profile_<?php echo $product_id;?>">
				...
				<span class="p_type"><center><?php echo get_post_meta($product_id,'productProfileID',true) ? $profileName[get_post_meta($product_id,'productProfileID',true)]:' ';?></center></span>
			</td>
			<td class="name column-visibility">
			...
			<td class="name column-visibility">
				...
				<?php }?>
				<?php } else{ ?>
				<span class="p_jet_status"><?php echo get_post_meta($product_id,'jet_product_status',true);?></span>
				<?php } ?>
			</td>
