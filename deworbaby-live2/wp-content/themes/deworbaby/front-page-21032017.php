  ...
  <div class="container">
    ...
    <div class="rightPart">
      <div class="videoPart">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/poster_img.jpg" alt="#">
        <?php //the_excerpt(); ?>                          
      </div>
    </div>
  </div>
...
<!-- about -->
  <section class="about clearfix">
    <div class="container clearfix">
      ...
      <?php $the_query = new WP_Query( 'page_id=165' ); ?>
      ...
      <h2><?php //echo $deworbaby_options['story_title']; ?></h2>
      <?php //echo $deworbaby_options['story_content']; ?>
      
      <?php if(!empty($deworbaby_options['story_btn_link'])){ ?>
      <div class="clearfix cntr">
      <a href="<?php echo $deworbaby_options['story_btn_link']; ?>" class="btn show_now hvr-shutter-out-horizontal"><span class="hvr-shutter-out-horizontal"><?php echo $deworbaby_options['story_btn_text']; ?></span></a>
      </div>
      <?php } ?>
