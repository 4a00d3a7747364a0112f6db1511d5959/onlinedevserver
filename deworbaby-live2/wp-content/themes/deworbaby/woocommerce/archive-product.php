...
<section class="sliderSec clearfix">
  <div class="slider-container">  
        <div class="slider" >    
          <div class="slide">    
            <img src="<?php echo $deworbaby_options['shop_page_banner']['url']; ?>">
            <div class="overlay">                
            </div>
              <div class="caption">
                <div class="capContent container">
                    <div class="maincaptionHolder">
                      <div class="mainCapInner">
                        <?php echo $deworbaby_options['shop_page_banner_content']; ?>
                      </div>
                    </div>
                </div>
...
<section class="bamboo_diapers clearfix">
	...
	?>
		...
		<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
			...
			<h2 class="page-title">Shop Now<?php //woocommerce_page_title(); ?></h2>
