			...
			if($total_featured_page_id){
				...
				?>
					<div class="ht-featured-post">
                      <div class="offer-box">
                         <div class="ht-featured-icon">
                        	<!--<i class="<?php echo esc_attr($total_featured_page_icon); ?>"></i>-->
                            <a href="<?php the_field('page_link'); ?>"><?php 
						...
						if(has_excerpt()){
							...
							echo total_excerpt( get_the_content(), 160); 
						}?>
						</div>
						<div class="ht-featured-link">
							<a href="<?php echo the_field('page_link'); ?>"><?php _e( 'KNOW MORE', 'total' ); ?></a>
						</div>
					</div>
				<?php
				endwhile;
