...
global $post;
if ( ! $post || $post->post_type !== 'opalhotel_hotel' || $post->post_status !== 'publish' ) {
	return;
}
...
<div class="opalhotel-hotel-info">
	...
	<div class="section address">
		<h4 class="title"><?php _e( 'Hotel Address', 'opal-hotel-room-booking' ); ?></h4>
	...
	<?php if ( $phone || $website ) : ?>
		<div class="section meta">
			<ul>
				<?php if ( $phone ) : ?>
					<li>
						<label class="label"><?php _e( 'Phone', 'opal-hotel-room-booking' ); ?></label>
						<span class="value"><?php echo esc_html( $phone ); ?></span>
					</li>
				<?php endif; ?>
				<?php if ( $website ) : ?>
					<li>
						<label class="label"><?php _e( 'Website', 'opal-hotel-room-booking' ); ?></label>
