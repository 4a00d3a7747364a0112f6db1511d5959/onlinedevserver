...
============================= <?php _e( 'Reservation Details', 'opal-hotel-room-booking' ); ?> =============================

<table>
	<thead>
		<tr>
			<th><?php _e( 'Room', 'opal-hotel-room-booking' ); ?></th>
			<th><?php _e( 'Data', 'opal-hotel-room-booking' ); ?></th>
			<th><?php _e( 'Package', 'opal-hotel-room-booking' ); ?></th>
			<th><?php _e( 'Price', 'opal-hotel-room-booking' ); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<tfoot>
			<tr>
				<td>
					<?php _e( 'Subtotal', 'opal-hotel-room-booking' ) ?>
				</td>
				<td>
			...
			<?php if ( opalhotel_tax_enable() ) : ?>
				<!-- tax -->
				<tr>
					<td><?php _e( 'Tax', 'opal-hotel-room-booking' ) ?></td>
					<td>
