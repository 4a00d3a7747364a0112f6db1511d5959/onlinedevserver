...
class OpalHotel_Post_Type_Room extends OpalHotel_Abstract_Post_Type {
	...
	public function __construct() {
		...
		$this->post_type_args = array(
            'labels'             => array(
                ...
                'use_featured_image'    => __( 'Use as room image', 'opal-hotel-room-booking' ),
            ),
            'public'             => true,
            'query_var'          => true,
    ...
    public function updated_messages( $messages ) {
        ...
        if ( ! in_array( $post_type, array( 'opalhotel_room' ) ) ) {
            return $messages;
        }

        $messages['opalhotel_room'] = array(
