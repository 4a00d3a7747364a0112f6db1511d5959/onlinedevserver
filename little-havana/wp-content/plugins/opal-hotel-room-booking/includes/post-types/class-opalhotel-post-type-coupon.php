...
/**
 * @Author: brainos
 * @Date:   2016-04-26 00:09:28
 * @Last Modified by:   someone
 * @Last Modified time: 2016-05-01 21:04:03
 */
...
class OpalHotel_Post_Type_Coupon extends OpalHotel_Abstract_Post_Type {
	...
	public function __construct() {
		...
		/* post type name*/
		$this->post_type = 'opalhotel_coupon';
    ...
    public function updated_messages( $messages ) {
        ...
        if ( ! in_array( $post_type, array( 'opalhotel_coupon' ) ) ) {
            return $messages;
        }

        $messages['opalhotel_coupon'] = array(
