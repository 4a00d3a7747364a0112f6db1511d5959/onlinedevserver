...
/**
 * @Author: brainos
 * @Date:   2016-04-23 22:45:32
 * @Last Modified by:   someone
 * @Last Modified time: 2016-05-14 14:01:39
 */
						...
						?>
							<tr valign="top"<?php echo isset( $field['trclass'] ) ? ' class="'.implode( '', $field['trclass'] ).'"' : '' ?>>
								...
								<td class="opalhotel-field opalhotel-field-<?php echo esc_attr( $field['type'] ) ?>">
									...
									<input type="checkbox" name="<?php echo isset( $field['id'] ) ? esc_attr( $field['id'] ) : '' ?>" value="1" <?php echo $custom_attr ?><?php checked( $val, 1 ); ?>/>
