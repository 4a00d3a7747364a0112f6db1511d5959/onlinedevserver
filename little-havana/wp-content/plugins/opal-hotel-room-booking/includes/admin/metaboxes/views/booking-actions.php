...
<div class="submitbox">
	<div id="minor-publishing">
		<div id="payments">
			<label for="_payment_method"><?php _e( 'Payment method', 'opal-hotel-room-booking' ); ?></label>
		...
		<div id="status-action">
			<label for="opalhotel-status-action"><?php _e( 'Payment status', 'opal-hotel-room-booking' ); ?></label>
		...
		<div id="customer">
			<label for="_customer_id"><?php _e( 'Customer', 'opal-hotel-room-booking' ); ?></label>
	...
	<div id="major-publishing-actions">
		<div id="delete-action">
			<?php if ( current_user_can( 'delete_post', $post->ID ) ) : ?>
				<a class="submitdelete deletion" href="<?php echo esc_attr( get_delete_post_link( $post->ID ) ) ?>"><?php _e( 'Move to Trash', 'opal-hotel-room-booking' ); ?></a>
			<?php endif; ?>
		</div>
