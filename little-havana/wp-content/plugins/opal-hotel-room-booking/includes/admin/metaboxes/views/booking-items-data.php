...
<table class="opalhotel_order_items" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			<th class="item"><?php _e( 'Items', 'opal-hotel-room-booking' ); ?></th>
			<th class="arrival_departure"><?php _e( 'Arrival - Departure', 'opal-hotel-room-booking' ); ?></th>
			<th class="night"><?php _e( 'Night', 'opal-hotel-room-booking' ); ?></th>
			<th class="qty"><?php _e( 'Qty', 'opal-hotel-room-booking' ); ?></th>
			<th class="total"><?php _e( 'Total', 'opal-hotel-room-booking' ); ?></th>
			<th class="action"><?php _e( 'Actions', 'opal-hotel-room-booking' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php if ( $rooms = $order->get_rooms() ) : ?>
			<?php foreach ( $rooms as $room ) : ?>
				...
				<tr>
					...
					<td class="action">
						<a href="#" class="opalhotel_tiptip edit_order_item" data-tip="<?php _e( 'Edit', 'opal-hotel-room-booking' ); ?>" data-id="<?php echo esc_attr( $room->order_item_id ); ?>" data-order-id="<?php echo esc_attr( $order->id ); ?>">
							<i class="fa fa-pencil"></i>
						</a>
						<a href="#" class="opalhotel_tiptip remove_order_item" data-tip="<?php _e( 'Remove', 'opal-hotel-room-booking' ); ?>" data-id="<?php echo esc_attr( $room->order_item_id ); ?>" data-order-id="<?php echo esc_attr( $order->id ); ?>">
				...
				<?php if ( $packages = $order->get_room_packages( $room->order_item_id ) ) : ?>
					<?php foreach ( $packages as $package ) : ?>
						...
						<tr>
							...
							<td class="total"><?php printf( '%s', opalhotel_format_price( $order_item->subtotal, $order->payment_currency ) ); ?></td>
							<td class="action">
								<!-- <a href="#" class="opalhotel_tiptip edit_order_item" data-tip="<?php _e( 'Edit', 'opal-hotel-room-booking' ); ?>" data-id="<?php echo esc_attr( $package->order_item_id ); ?>" data-order-id="<?php echo esc_attr( $order->id ); ?>">
									<i class="fa fa-pencil"></i>
								</a> -->
								<a href="#" class="opalhotel_tiptip remove_order_item" data-tip="<?php _e( 'Remove', 'opal-hotel-room-booking' ); ?>" data-id="<?php echo esc_attr( $package->order_item_id ); ?>" data-order-id="<?php echo esc_attr( $order->id ); ?>">
									<i class="fa fa-times-circle"></i>
								</a>
							</td>
						</tr>
	...
	<tfoot>
		<tr class="add_line_item_tr">
			<td colspan="6">
				<a href="#" class="button add_line_item"><?php _e( 'Add Line Item', 'opal-hotel-room-booking' ); ?></a>
			</td>
		</tr>
		<tr>
			<td colspan="5"><?php _e( 'Subtotal', 'opal-hotel-room-booking' ); ?></td>
		...
		<?php if ( $order->coupon ) : ?>
			<tr>
				<td colspan="5">
					...
					(<a href="#" class="remove_coupon" data-order-id="<?php echo esc_attr( $order->id ); ?>"><?php _e( 'Remove Coupon','opal-hotel-room-booking' ); ?></a>)
				</td>
				<td>
		...
		<?php else : ?>
			<tr>
				<td colspan="5">
					<select style="min-width: 150px;" name="_coupon" id="_coupon_code" data-placeholder="<?php _e( 'Enter Coupon Code', 'opal-hotel-room-booking' ) ?>" data-order-id="<?php echo esc_attr( $order->id ); ?>"></select>
				</td>
				<td>
					<a href="#" class="button add_coupon" data-order-id="<?php echo esc_attr( $order->id ); ?>"><?php _e( 'Add Coupon', 'opal-hotel-room-booking' ); ?></a>
				</td>
			</tr>
		<?php endif; ?>
		<?php if ( opalhotel_tax_enable() ) : ?>
			...
			<tr class="opalhotel-review-subtotal">
				<td colspan="5"><?php _e( 'Tax', 'opal-hotel-room-booking' ) ?></td>
				<td>
