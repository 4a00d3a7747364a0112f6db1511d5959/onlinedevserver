			...
			<?php foreach ( $tab_panels as $key => $tab ) : ?>
				...
				<?php if ( $key === 'general' ) : ?>
					...
					<div id="general_coupon_data" class="opalhotel_room_data_panel active">
						...
						<div class="opalhotel_field_group">
							<label for="discount_type"><?php _e( 'Discount type', 'opal-hotel-room-booking' ); ?></label>
						...
						<!-- discount expiry -->
						<div class="opalhotel_field_group">
							<label for="_discount_expire"><?php _e( 'Expiry', 'opal-hotel-room-booking' ); ?></label>
				...
				<?php elseif ( $key === 'restriction' ) : ?>
					...
					<div id="restriction_conpon_data" class="opalhotel_room_data_panel">
						...
						<!-- discount minimum -->
						<div class="opalhotel_field_group">
							<label for="discount_minimum_spend"><?php _e( 'Minimum spend', 'opal-hotel-room-booking' ); ?></label>
						...
						<!-- discount maximum -->
						<div class="opalhotel_field_group">
							<label for="discount_maximum_spend"><?php _e( 'Maximum spend', 'opal-hotel-room-booking' ); ?></label>
				...
				<?php elseif ( $key === 'limit' ) : ?>
					...
					<div id="limit_coupon_data" class="opalhotel_room_data_panel">
						...
						<!-- discount maximum -->
						<div class="opalhotel_field_group">
							<label for="useage_time_limit"><?php _e( 'Useage time limit', 'opal-hotel-room-booking' ); ?></label>
						...
						<!-- discount maximum -->
						<div class="opalhotel_field_group">
							<label for="useage_time"><?php _e( 'Useaged time', 'opal-hotel-room-booking' ); ?></label>
