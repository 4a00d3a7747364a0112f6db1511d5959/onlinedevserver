		...
		?>
			<div id="opalhotel-room-pricing">
				<div id="opalhotel_pricing_panel">
					...
					<h3><?php _e( 'Update Pricing', 'opal-hotel-room-booking' ); ?></h3>
					<div class="opalhotel_datepick_wrap panel update_pricing">
						...
						<p>
							<select name="price_type">
								<option value="new_price"><?php _e( 'New Price', 'opal-hotel-room-booking' ); ?></option>
								<option value="subtract_price"><?php _e( 'Subtract Price', 'opal-hotel-room-booking' ); ?></option>
								<option value="append_price"><?php _e( 'Add To Price', 'opal-hotel-room-booking' ); ?></option>
								<option value="increase_percent"><?php _e( 'Increase % Price', 'opal-hotel-room-booking' ); ?></option>
								<option value="decrease_percent"><?php _e( 'Decrease % Price', 'opal-hotel-room-booking' ); ?></option>
							</select>
							<input type="number" step="any" name="amount" />
						</p>
						<a href="#" id="opalhotel_update_pricing" class="button"><?php _e( 'Update', 'opal-hotel-room-booking' ); ?></a>
					</div>
					<!-- Date picker wraper -->
					<h3><?php _e( 'Filter', 'opal-hotel-room-booking' ); ?></h3>
					<div class="opalhotel_datepick_wrap panel filter_pricing">
						...
						<a href="#" id="opalhotel_pricing_filter" class="button"><?php _e( 'Filter', 'opal-hotel-room-booking' ); ?></a>
					</div>
				</div>
