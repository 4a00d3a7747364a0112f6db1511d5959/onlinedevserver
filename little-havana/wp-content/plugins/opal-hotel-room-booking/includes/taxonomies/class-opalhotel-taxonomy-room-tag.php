...
/**
 * @Author: brainos
 * @Date:   2016-04-24 09:22:55
 * @Last Modified by:   opalhotel_remove_extra
 * @Last Modified time: 2016-04-27 23:43:01
 */
...
class OpalHotel_Room_Tag_Taxnomy extends OpalHotel_Abstract_Taxonomy {
	...
	public function __construct() {
		...
		/* taxonomy name */
		$this->taxonomy = 'opalhotel_room_tag';
		...
		$this->taxonomy_args = array(
                ...
                'labels' => array(
                    ...
                    'menu_name'         => _x( 'Room Tags', 'Room Tags', 'opal-hotel-room-booking' ),
