...
class OpalHotel_Field_Map {
	...
	public static function setup_admin_scripts() {
		...
		$api = apply_filters( 'opalhotel_google_map_api_uri',  '//maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places&amp;key='.$key   );
		wp_enqueue_script("opalhotel-google-maps", $api, null, "0.0.1", false);
